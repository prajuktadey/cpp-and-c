...
class Developer: Employee //base class: Employee, derived class: Developer
{
   public:
      ...
      void FixBug()
      {
        ...
        //getName is what we are using to access properties of our Employee class
        //we are accessing directly properties of the developer class by FavProgrammingLanguage
      }
